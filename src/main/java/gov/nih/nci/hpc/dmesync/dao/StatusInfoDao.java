...
public interface StatusInfoDao<T extends StatusInfo> extends JpaRepository<T, Long> {
  ...
  /**
   * findFirstByOriginalFilePathAndSourceFilePathAndStatus
   * @param originalFilePath the original file path
   * @param sourceFilePath the source file path
   * @param status the status
   * @return the StatusInfo object
   */
  StatusInfo findFirstByOriginalFilePathAndSourceFilePathAndStatus(
   ...
   * @return  the StatusInfo object
   */
  StatusInfo findTopBySourceFileNameAndRunIdAndOriginalFilePath(
