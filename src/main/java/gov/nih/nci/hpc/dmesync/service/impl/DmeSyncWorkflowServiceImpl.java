...
public class DmeSyncWorkflowServiceImpl implements DmeSyncWorkflowService {
  ...
  public List<StatusInfo> findAllByDocAndLikeOriginalFilePath(String doc,String originalFilePath) {
    return statusInfoDao.findAllByDocAndLikeOriginalFilePath(doc,originalFilePath);
  }
  ...
  @Override
  public StatusInfo findFirstStatusInfoByOriginalFilePathAndSourceFilePathAndStatus(
      String originalFilePath, String sourceFilePath, String status) {
    return statusInfoDao.findFirstByOriginalFilePathAndSourceFilePathAndStatus(
        originalFilePath, sourceFilePath, status);
  }
  ...
  @Override
  public StatusInfo findTopStatusInfoByDocAndSourceFilePathAndLikeRunId( String doc,String sourceFilePath, String runId) {
    return statusInfoDao.findTopStatusInfoByDocAndSourceFilePathAndLikeRunId(doc,
